          ...
          >
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                This project represents a significant milestone in my development journey.
                It showcases my ability to work with modern web technologies and create
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3 mt-6">Challenges & Solutions</h3>
              <p className="text-gray-600 leading-relaxed">
                During the development of this project, I encountered various challenges
                that required creative problem-solving and research. The experience helped
                me grow as a developer and learn new techniques that I now apply to all my projects.
              </p>
            </div>
          </motion.div>
        </div>
